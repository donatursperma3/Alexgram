    ...
    public void setData(TLObject peer, CharSequence title, CharSequence subtitle, int bookmarkCount, boolean divider) {
        ...
        if (peer instanceof TLRPC.User user) {
            if (UserObject.isUserSelf(user)) {
                CombinedDrawable combinedDrawable = Theme.createCircleDrawableWithIcon(dp(40), IconsResources.getConversion(R.drawable.chats_saved));
            ...
            CombinedDrawable combinedDrawable = Theme.createCircleDrawableWithIcon(dp(40), IconsResources.getConversion(R.drawable.ghost));
            combinedDrawable.setIconSize(dp(20), dp(20));
