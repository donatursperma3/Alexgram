...
public class Utilities {
    ...
    public static void blurBitmap(Object bitmap, int radius, int unpin, int w, int h, int rowBytes) {
        blurBitmap(bitmap, radius);
    }
    public native static int needInvert(Object bitmap);
    public static int needInvert(Object bitmap, int unpin, int w, int h, int rowBytes) {
        return needInvert(bitmap);
    }
    public static void pinBitmap(Object bitmap) {}
